# https://nxphuong.github.io — MXD Canonical Skeleton
...
## Triển khai
1) Upload toàn bộ lên repo `nxphuong.github.io` (root).
...
4) Share link sản phẩm: `https://nxphuong.github.io/g.html?sku=<SKU>`.
